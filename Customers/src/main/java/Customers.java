 ...
 * @author AmyrH
 */
public class Customers extends Stakeholder{
    ...
    public Customers(String stHolderId, String firstName, String surName, String addr, String dob, double cred, boolean canRent)    {
    	super(stHolderId);
